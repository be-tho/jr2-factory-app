  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <PageHeader
          title="Categorías"
          description="Tipos de prenda y líneas. Las inactivas no aparecen al crear artículos."
        />
        <Link
      ...
      {loading && !errorMessage ? (
        <p className="text-center text-sm text-brand-ink-muted">Cargando categorías…</p>
      ) : null}
