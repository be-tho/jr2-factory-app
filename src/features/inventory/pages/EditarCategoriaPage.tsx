...
export function EditarCategoriaPage() {
  ...
  if (!id) {
    return (
      <div className="space-y-6">
        <PageHeader title="Editar categoría" description="No se pudo cargar el registro." />
  ...
  if (isPending) {
    return (
      <div className="space-y-6">
        <PageHeader title="Editar categoría" description="Cargando…" />
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        <PageHeader title="Editar categoría" description="Nombre y visibilidad en formularios de artículos." />
        <Link
          to="/inventario/categorias"
